...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{../../../assets/backend-cv-UHG.png} % path to your image
  \caption{Use hierarchy among backend modules}
  \label{fig:backend-UHG}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{../../../assets/frontend.png} % path to your image
  \caption{Use hierarchy among frontend modules}
  \label{fig:frontend-UHG}
\end{figure}

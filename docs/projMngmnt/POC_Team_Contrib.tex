...
We therefore interpret the raw commit distribution with caution. When accounting for model R\&D and training conducted outside \texttt{main}, the overall contribution across team members is roughly balanced. Reproducible training scripts and experiment summaries will be upstreamed in subsequent PRs.

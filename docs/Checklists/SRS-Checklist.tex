...
\begin{itemize}
  ...
  \item Follows the template, all parts present
        \begin{todolist}
          ...
          \begin{itemize}
            \item SRS, which is suited to scientific computing problems (rare choice (suited to
                  physical phenomena and numerical libraries))
            \item SRS-Volere, which is a complex, comprehensive, general, template (long,
                  repetitive)
            \item SRS-Meyer, which is a simpler, general purpose template (reasonable scope, good
                  generic choice)
          \end{itemize}

...
The following checklist is relevant when starting a new project in the SE
capstone course.
...
\begin{itemize}
  ...
  \item Form team and select project
        \begin{todolist}
          ...
          {Potential Projects})
          \item Use the \href{https://github.com/smiths/capTemplate/} {capTemplate} template
          (green button). \textbf{Do not fork the template repo and do not start your own
            repo from scratch.}
          \item Your project name (as used in your documentation, and in your GitHub repo link)
          identifies the project in some way. The project name should not be a generic
          name, like \texttt{capstone}.

...
\begin{itemize}
  ...
  \item LaTeX
        \begin{todolist}
          \item Template comments do not show in the pdf version, either by removing them, or
          by turning them off.
  ...
  \item Overall qualities of documentation
        \begin{todolist}
          ...
          \item Plans for what to do with description data (performance, usability, etc). This
          may involve saying what plots will be generated.
          ...
          \item Traceability between test cases and requirements is summarized (likely in a
          table)
        \end{todolist}

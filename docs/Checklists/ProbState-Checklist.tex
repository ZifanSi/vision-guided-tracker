...
\begin{itemize}
  ...
  \item Overall qualities of documentation
        \begin{todolist}
          ...
          language (unless this is a true constraint) or the algorithm choices (unless
          the algorithm is the ``what'' rather than the ``how''))
          \item Output of software is unambiguous
          \item Inputs to software are unambiguous
          \item Document is simple (for instance, there is no need for a table of contents)

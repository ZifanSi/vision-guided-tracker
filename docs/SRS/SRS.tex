...
\begin{enumerate}[label=MD-SL \arabic*., wide=0pt, leftmargin=*]
  ...
  \item \emph{The system must operate normally without access to the public internet.}\\[2mm]
        {\bf Rationale:} Launch sites are often located in remote areas without reliable internet connectivity.\\
        {\bf Fit Criterion:} All product use cases are fully functional when the system is operated in an offline environment with no access to the public internet.
\end{enumerate}

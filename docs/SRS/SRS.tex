...
To track small-scale model rocket launches with apogee less than 200m.

\textbf{Advantage:}

We want to provide insights into the flight performance by having high quality
flight footage.

\textbf{Measure:}

Deploy the project at model rocket launch sites and see if it successfully
trackes the rockets.

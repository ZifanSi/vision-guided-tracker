...
The following are the planned process of demonstrating the PoC:

\begin{enumerate}
  \item Connect the Jetson to a display and power it on.
  \item Demonstrate the realtime video output.
  \item Open the web interface for operator control.
  \item Demonstrate manual gimbal control in idle state.
  \item Arm the system using the web interface.
  \item Demonstrate the system autonomously controlling the gimbal in tracking state,
        tracking a moving image of a rocket.
\end{enumerate}

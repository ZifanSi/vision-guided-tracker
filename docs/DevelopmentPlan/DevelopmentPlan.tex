...
for the Rocket Team while internalizing a full software development lifecycle.
We will practice requirements engineering, UI and API design reviews, iterative
prototyping, test and validation, CI based release, and formal demo handoff.
We target a clear, interview ready artifact: a Web UI showcasing real time
...
to reacquire target, stability during long runs). Achieving an A+ is welcome,
but never at the cost of engineering rigor, ethics, or team health.

...
\begin{itemize}
  ...
  \item Python:
        ...
        use pytest + coverage for tests ( > 50\%) on Python 3.9–3.11 across Linux, macOS, and Windows; perform SAST with Bandit; all of the above are enforced via GitHub Actions.
  \item Typescript:

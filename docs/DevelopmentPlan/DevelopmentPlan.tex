...
This project adopts the MIT license, which can be accessed at this
...
\begin{itemize}
  \item \textbf{Discord}: Used for general team communication, informal discussions, quick updates, and meetings.
  \item \textbf{Zoom}: Used for meetings with advisors
  \item \textbf{GitHub}: Used for all code-related discussions and project management.
\end{itemize}
